...
class RemoteRAG(RAGModel):
    """
    RAG-Naive con FAISS + LLM remoto via proxy.
    - Recupera contexto con FAISS
    - Usa LLM remoto vía proxy OpenAI-compatible
    ...
    def generate_response(self, query: str) -> str:
        ...
        if retrieved_docs:
            ...
            try:
                ...
                logger.error(f"Error llamando LLM remoto: {e}")
                raise
